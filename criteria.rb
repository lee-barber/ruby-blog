...
# You’ll be building a micro-blogging app in a group of three
...
# Create .gitignore file in advance and place all SASS-related files there
...
# Create JS functionality that a minimum of one number is required for password
# Your project should look good, don’t make the front end bare-bones. Feel free to use JavaScript for awesome front end interactions! Good luck, have fun, and learn a lot!

# Grading Criteria:

# Should have a user model with sign up, in, login, edit, delete functionality
# There is JS functionality applied on the sign up password
